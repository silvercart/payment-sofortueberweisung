...
class SilvercartPaymentSofortueberweisungShoppingCart extends DataObjectDecorator {
     ...
     * @since 15.11.2012
     */
    public function saveSaferpayID($sofortueberweisungID) {
        $this->owner->setField('saferpayIdentifier', (string) $sofortueberweisungID);
        $this->owner->write();
    }
    ...
    public function saveSofortueberweisungToken($sofortueberweisungToken) {
        $this->owner->setField('saferpayToken', (string) $sofortueberweisungToken);
        $this->owner->write();
    }
}